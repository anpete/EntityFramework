...
{
    public class QuerySubquerySqlServerTest : QuerySubqueryTestBase<NorthwindQuerySqlServerFixture>
    {
        public override void Select_Where_Subquery()
        {
            base.Select_Where_Subquery();
...
WHERE (
    ...
    WHERE [od].[OrderID] = [o].[OrderID]
        ...
        public override void Select_Where_Subquery_Included()
        {
            base.Select_Where_Subquery_Included();
...
WHERE (
    ...
    WHERE [o].[CustomerID] = [c].[CustomerID]
        ...
        public override void Select_Subquery()
        {
            base.Select_Subquery();
...
FROM [Customers] AS [c]",
        ...
        public override void Select_Subqueries()
        {
            base.Select_Subqueries();
...
FROM [Customers] AS [c]",
        ...
        public override void Select_Where_Subqueries()
        {
            base.Select_Where_Subqueries();
...
WHERE ((
    ...
    WHERE [o].[CustomerID] = [c].[CustomerID]
        ...
        public override void Select_Where_Subquery_Multiple_Access()
        {
            base.Select_Where_Subquery_Multiple_Access();
...
WHERE ((
    ...
    WHERE [o].[CustomerID] = [c].[CustomerID]
        ...
        public override void Select_Subqueries_Where_Subqueries()
        {
            base.Select_Subqueries_Where_Subqueries();
...
WHERE (([o.Customer].[City] = 'Seattle') AND [o.Customer].[City] IS NOT NULL) AND (([o.Customer].[Phone] <> '555 555 5555') OR [o.Customer].[Phone] IS NULL)",
        ...
        public override void Select_Where_Subquery_Client()
        {
            base.Select_Where_Subquery_Client();
...
INNER JOIN [Customers] AS [o.Customer] ON [o].[CustomerID] = [o.Customer].[CustomerID]",
        ...
        public override void Select_Singleton_Subquery_With_Member_Access()
        {
            base.Select_Singleton_Subquery_With_Member_Access();
...
WHERE (([o.Customer].[City] = 'Seattle') AND [o.Customer].[City] IS NOT NULL) AND (([o.Customer].[Phone] <> '555 555 5555') OR [o.Customer].[Phone] IS NULL)",
        ...
        public override void Singleton_Subquery_With_Member_Access()
        {
            base.Singleton_Subquery_With_Member_Access();
...
WHERE (([o.Customer].[City] = 'Seattle') AND [o.Customer].[City] IS NOT NULL) AND (([o.Customer].[Phone] <> '555 555 5555') OR [o.Customer].[Phone] IS NULL)",
        ...
        public override void Select_Where_Subquery_Scalar_Equals_Subquery_Scalar()
        {
            base.Select_Where_Subquery_Scalar_Equals_Subquery_Scalar();
...
WHERE ([o1.Customer].[City] = [o2.Customer].[City]) OR ([o1.Customer].[City] IS NULL AND [o2.Customer].[City] IS NULL)",
        ...
        public override void Select_Where_Subquery_Scalar_Equals_Subquery_Scalar_Projected()
        {
            base.Select_Where_Subquery_Scalar_Equals_Subquery_Scalar_Projected();
...
WHERE ([o1.Customer].[City] = [o2.Customer].[City]) OR ([o1.Customer].[City] IS NULL AND [o2.Customer].[City] IS NULL)",
        ...
        public override void Select_Where_Subquery_Equals_Subquery()
        {
            base.Select_Where_Subquery_Equals_Subquery();
...
WHERE ([o1].[CustomerID] = [o2].[CustomerID]) OR ([o1].[CustomerID] IS NULL AND [o2].[CustomerID] IS NULL)",
        ...
        public override void Select_Where_Subquery_Null()
        {
            base.Select_Where_Subquery_Null();
...
WHERE [e].[ReportsTo] IS NULL",
        ...
        public override void Select_Where_Subquery_Null_Deep()
        {
            base.Select_Where_Subquery_Null_Deep();
...
WHERE [e.Manager].[ReportsTo] IS NULL",
        ...
        public override void Select_Where_Subquery_Null_Reverse()
        {
            base.Select_Where_Subquery_Null_Reverse();
...
FROM [Orders] AS [o]",
        ...
        public override void Subquery_fk_based_inside_contains()
        {
            base.Subquery_fk_based_inside_contains();
...
WHERE [o].[CustomerID] IN ('ALFKI')",
        ...
        public override void Subquery_inside_contains()
        {
            base.Subquery_inside_contains();
...
WHERE [o.Customer].[City] IN ('Novigrad', 'Seattle')",
        ...
        public override void Subquery_inside_contains_nested()
        {
            base.Subquery_inside_contains_nested();
...
WHERE [od.Order.Customer].[City] IN ('Novigrad', 'Seattle')",
        ...
        public override void Subquery_from_join_clause_inside_contains()
        {
            base.Subquery_from_join_clause_inside_contains();
...
WHERE (
    ...
    END
        ...
        public override void Subquery_in_subquery_referencing_outer_query()
        {
            base.Subquery_in_subquery_referencing_outer_query();
...
WHERE (
    ...
    WHERE ([o.Customer].[Country] = [od.Order.Customer].[Country]) OR ([o.Customer].[Country] IS NULL AND [od.Order.Customer].[Country] IS NULL)
        ...
        */
        ...
        public QuerySubquerySqlServerTest(NorthwindQuerySqlServerFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
