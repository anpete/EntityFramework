...
namespace Microsoft.EntityFrameworkCore.FunctionalTests
{
    ...
    public abstract class QuerySubqueryTestBase<TFixture> : IClassFixture<TFixture>
        where TFixture : NorthwindQueryFixtureBase, new()
    {
        [ConditionalFact]
        public virtual void Select_Where_Subquery()
        {
                ...
                var orders
                    = (from o in context.Orders
                        where (from c in context.Customers
                               ...
                               select c).FirstOrDefault().City == "Seattle"
                        select o).ToList();
        ...
        [ConditionalFact]
        public virtual void Select_Where_Subquery_Included()
        {
            using (var context = CreateContext())
            {
                var orders
        ...
        [ConditionalFact]
        public virtual void Select_Subquery()
        {
            using (var context = CreateContext())
            {
                var orders
                    = (from o in context.Orders
                       select (from c in context.Customers
                               where o.CustomerID == c.CustomerID
                               select c).FirstOrDefault()).ToList();
        ...
        [ConditionalFact]
        public virtual void Select_Subqueries()
        {
            using (var context = CreateContext())
            {
                var orders
                    = (from o in context.Orders
                       select new
                       {
                           A = (from c in context.Customers
                                where o.CustomerID == c.CustomerID
                                select c).FirstOrDefault(),
                           B = (from c in context.Customers
                                where o.CustomerID == c.CustomerID
                                select c).FirstOrDefault()
                       }).ToList();
        ...
        [ConditionalFact]
        public virtual void Select_Where_Subqueries()
        {
            using (var context = CreateContext())
            {
                var orders
                    = (from o in context.Orders
                       where ((from c in context.Customers
                             ...
                             && ((from c in context.Customers
                                  where o.CustomerID == c.CustomerID
                                  select c).FirstOrDefault().Phone != "555 555 5555")
                       select o).ToList();
        ...
        [ConditionalFact]
        public virtual void Select_Where_Subquery_Multiple_Access()
        {
            using (var context = CreateContext())
            {
                var orders
        ...
        [ConditionalFact]
        public virtual void Select_Subqueries_Where_Subqueries()
        {
            using (var context = CreateContext())
            {
                var orders
        ...
        /*
        [ConditionalFact]
        public virtual async Task Select_Where_Subquery_Async()
        {
            using (var context = CreateContext())
            {
                var orders
                    = await (from o in context.Orders
        ...
        [ConditionalFact]
        public virtual void Select_Where_Subquery_Scalar_Equals_Subquery_Scalar()
        {
            using (var context = CreateContext())
            {
                var orders
        ...
        [ConditionalFact]
        public virtual void Select_Where_Subquery_Scalar_Equals_Subquery_Scalar_Projected()
        {
            using (var context = CreateContext())
            {
                var orders
        ...
        [ConditionalFact]
        public virtual void Select_Where_Subquery_Client()
        {
            using (var context = CreateContext())
            {
                var orders
        ...
        [ConditionalFact]
        public virtual void Select_Where_Subquery_Null()
        {
            using (var context = CreateContext())
            {
                var employees
        ...
        [ConditionalFact]
        public virtual void Select_Where_Subquery_Null_Reverse()
        {
            using (var context = CreateContext())
            {
                var employees
        ...
        [ConditionalFact]
        public virtual void Select_Where_Subquery_Null_Deep()
        {
            using (var context = CreateContext())
            {
                var employees
        ...
        [ConditionalFact]
        public virtual void Select_Where_Subquery_Equals_Subquery()
        {
            using (var context = CreateContext())
            {
                var orders
        ...
        [ConditionalFact]
        public virtual void Singleton_Subquery_With_Member_Access()
        {
            using (var context = CreateContext())
            {
                var orders
        ...
        [ConditionalFact]
        public virtual void Select_Singleton_Subquery_With_Member_Access()
        {
            using (var context = CreateContext())
            {
                var orders
        ...
        [ConditionalFact]
        public virtual async Task Select_Singleton_Subquery_With_Member_Access_Async()
        {
            using (var context = CreateContext())
            {
                var orders
        ...
        [ConditionalFact]
        public virtual void Subquery_fk_based_inside_contains()
        {
            using (var context = CreateContext())
            {
                var query
        ...
        [ConditionalFact]
        public virtual void Subquery_inside_contains()
        {
            using (var context = CreateContext())
            {
                var query
        ...
        [ConditionalFact]
        public virtual void Subquery_inside_contains_nested()
        {
            using (var context = CreateContext())
            {
                var query
        ...
        [ConditionalFact]
        public virtual void Subquery_from_join_clause_inside_contains()
        {
            using (var context = CreateContext())
            {
        ...
        [ConditionalFact]
        public virtual void Subquery_in_subquery_referencing_outer_query()
        {
            using (var context = CreateContext())
            {
                var query = from o in context.Orders
        ...
        */
        protected QuerySubqueryTestBase(TFixture fixture)
        {
            Fixture = fixture;
        }
