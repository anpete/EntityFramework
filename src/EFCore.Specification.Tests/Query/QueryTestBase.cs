...
namespace Microsoft.EntityFrameworkCore.Query
{
        ...
        where TFixture : class, IQueryFixtureBase, new()
    {
        ...
        public virtual void AssertQuery<TItem1>(
            ...
            int entryCount = 0)
            where TItem1 : class
            => Fixture.QueryAsserter.AssertQuery(query, query, elementSorter, elementAsserter, assertOrder, entryCount).Wait();
        ...
        public virtual void AssertQuery<TItem1>(
            ...
            int entryCount = 0)
            where TItem1 : class
            => Fixture.QueryAsserter.AssertQuery(actualQuery, expectedQuery, elementSorter, elementAsserter, assertOrder, entryCount).Wait();
