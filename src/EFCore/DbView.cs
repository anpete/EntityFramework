...
namespace Microsoft.EntityFrameworkCore
{
    /// <summary>
    ///     <para>
    ///         A <see cref="DbView{TView}" /> can be used to query and save instances of <typeparamref name="TView" />.
    ...
    ///     </para>
    ///     <para>
    ///         Depending on the database being used, some parts of a LINQ query against a <see cref="DbSet{TView}" />
    ...
    ///         property on a derived <see cref="DbContext" /> or from the <see cref="DbContext.View{TView}" />
    ///         method.
    ///     </para>
    /// </summary>
    /// <typeparam name="TView"> The type of entity being operated on by this set. </typeparam>
    public abstract class DbView<TView> : IQueryable<TView>, IAsyncEnumerableAccessor<TView>, IInfrastructure<IServiceProvider>
    {
        /// <summary>
