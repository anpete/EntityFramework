...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    ...
    /// </summary>
    public class InternalStructuralTypeBuilder<TStructuralType> : InternalMetadataItemBuilder<TStructuralType>
        where TStructuralType : StructuralType
    {
        /// <summary>
        ///     This API supports the Entity Framework Core infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected InternalStructuralTypeBuilder(TStructuralType metadata, InternalModelBuilder modelBuilder)
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected virtual InternalKeyBuilder HasKeyInternal(IReadOnlyList<Property> properties, ConfigurationSource? configurationSource)
        {
            if (properties == null)
            {
                return null;
        ...
        private class PropertyBuildersSnapshot
        {
            ...
            public void Attach(InternalStructuralTypeBuilder<TStructuralType> entityTypeBuilder)
            {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected static RelationshipBuilderSnapshot DetachRelationship([NotNull] ForeignKey foreignKey)
        {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected virtual void RemoveKeyIfUnused([NotNull] Key key)
        {
            ...
            [CanBeNull] IReadOnlyList<Property> properties, ConfigurationSource? configurationSource)
        {
            ...
            for (var i = 0; i < actualProperties.Length; i++)
            {
                ...
                var builder = property.Builder != null 
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected class RelationshipBuilderSnapshot
        {
            /// <summary>
            ///     This API supports the Entity Framework Core infrastructure and is not intended to be used
            ///     directly from your code. This API may change or be removed in future releases.
            ...
            /// </summary>
            [DebuggerStepThrough]
            public void Attach() => Relationship.Attach(RelationshipConfigurationSource);
        }
    }
}
