...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    ...
    /// </summary>
    public class EntityTypePathComparer : IComparer<IEntityType>, IComparer<IStructuralType>
    {
        /// <summary>
        ///     This API supports the Entity Framework Core infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public virtual int Compare(IStructuralType x, IStructuralType y) => Compare((IEntityType)x, (IEntityType)y);
        ...
        public virtual int GetHashCode([NotNull] IEntityType entityType)
        {
            ...
            while (true)
            {
                result = (result * 397) ^ StringComparer.Ordinal.GetHashCode(entityType.Name);
                ...
                result = (result * 397) ^ StringComparer.Ordinal.GetHashCode(definingNavigationName);
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public virtual int GetHashCode([NotNull] IStructuralType structuralType)
            => GetHashCode((IEntityType)structuralType);
    }
}
