...
{
    /// <summary>
    ///     Represents a structural type in an <see cref="IModel" />.
    /// </summary>
    public interface IStructuralType : ITypeBase
    {
        /// <summary>
        ///     Gets the base type of the structural type. Returns null if this is not a derived type in an inheritance hierarchy.
        /// </summary>
        IStructuralType BaseType { get; }
